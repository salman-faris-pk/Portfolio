    ...
    >
      <section className="bg-white max-w-[42rem] border border-black/5 rounded-lg overflow-hidden
        ...
        <div className="pt-4 pb-7 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full
          ...
          <p className="mt-2 leading-relaxed text-gray-800 text-sm dark:text-white/70 px-2 md:px-0">{description}</p>
        ...
        <Image
          ...
          className="absolute opacity-15 sm:opacity-100 top-8 -right-40 rounded-t-lg shadow-2xl transition group-hover:scale-[1.04]
